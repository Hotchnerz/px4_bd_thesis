...
from px4_msgs.msg import OffboardControlMode, TrajectorySetpoint, Timesync, VehicleCommand, VehicleStatus
...
class ArucoLanding(Node):
    def __init__(self):
        ...
        self.nav_state_subscriber = self.create_subscription(VehicleStatus, '/fmu/vehicle_status/out', self.nav_state_callback, 10)
    ...
    def timer_callback(self):
        ...
        elif (self.nav_state == VehicleStatus.NAVIGATION_STATE_OFFBOARD and self.offboard_setpoint_counter >= 15):
