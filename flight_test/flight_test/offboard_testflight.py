...
class OffboardControl(Node):
    ...
    def __init__(self):
        ...
        self.offboard_control_mode_pub = self.create_publisher(OffboardControlMode, 'fmu/offboard_control_mode/in', 10)
        self.vehicle_cmd_pub = self.create_publisher(VehicleCommand, '/fmu/vehicle_command/in', 10)
        ...
        self.aruco_setpoint = [self.curr_x, self.curr_y, self.curr_z]
